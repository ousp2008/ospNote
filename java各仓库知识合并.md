# [第1个CS-Notes](https://github.com/ousp2008/CS-Notes)
...
- ![pencil2](https://github.githubassets.com/images/icons/emoji/unicode/270f.png) 主流框架/软件
  ...
  - [ZooKeeper](https://github.com/ousp2008/JavaGuide#zookeeper)
...
[![license](https://camo.githubusercontent.com/5332f4e1f7cb90f2caff23ee4d60632c7e36fe6a/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f6c6963656e73652d4174747269627574696f6e2d2d4e6f6e436f6d6d65726369616c253230342e302532302d627269676874677265656e2e737667)](https://github.com/doocs/advanced-java/blob/master/LICENSE) [![original](https://camo.githubusercontent.com/8224988a63c00315d51c961427b8d41188fdc5a3/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f6f726967696e616c2d2545342542382541442545352538442538452545372539462542332545362539442538392d6f72616e67652e737667)](https://github.com/doocs/advanced-java) [![stars](https://camo.githubusercontent.com/87a26d3728563a25595218d2f681d1e14e26625b/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f73746172732f646f6f63732f616476616e6365642d6a6176612e737667)](https://github.com/doocs/advanced-java/stargazers) [![forks](https://camo.githubusercontent.com/1b09a4864b27a5276553b586658dab7e923d88cc/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f666f726b732f646f6f63732f616476616e6365642d6a6176612e737667)](https://github.com/doocs/advanced-java/network/members) [![issues](https://camo.githubusercontent.com/da25fcf856e52dda6c0190467ee40f45be29d4ca/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f6973737565732f646f6f63732f616476616e6365642d6a6176612e737667)](https://github.com/doocs/advanced-java/issues) [![PRs Welcome](https://camo.githubusercontent.com/d4e0f63e9613ee474a7dfdc23c240b9795712c96/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f5052732d77656c636f6d652d627269676874677265656e2e737667)](http://makeapullrequest.com/)
...
### [消息队列](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/mq-interview.md)

- [为什么使用消息队列？消息队列有什么优点和缺点？Kafka、ActiveMQ、RabbitMQ、RocketMQ 都有什么优点和缺点？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/why-mq.md)
- [如何保证消息队列的高可用？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/how-to-ensure-high-availability-of-message-queues.md)
- [如何保证消息不被重复消费？（如何保证消息消费的幂等性）](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/how-to-ensure-that-messages-are-not-repeatedly-consumed.md)
- [如何保证消息的可靠性传输？（如何处理消息丢失的问题）](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/how-to-ensure-the-reliable-transmission-of-messages.md)
- [如何保证消息的顺序性？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/how-to-ensure-the-order-of-messages.md)
- [如何解决消息队列的延时以及过期失效问题？消息队列满了以后该怎么处理？有几百万消息持续积压几小时，说说怎么解决？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/mq-time-delay-and-expired-failure.md)
- [如果让你写一个消息队列，该如何进行架构设计啊？说一下你的思路。](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/mq-design.md)

### [搜索引擎](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/es-introduction.md)

- [es 的分布式架构原理能说一下么（es 是如何实现分布式的啊）？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/es-architecture.md)
- [es 写入数据的工作原理是什么啊？es 查询数据的工作原理是什么啊？底层的 lucene 介绍一下呗？倒排索引了解吗？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/es-write-query-search.md)
- [es 在数据量很大的情况下（数十亿级别）如何提高查询效率啊？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/es-optimizing-query-performance.md)
- [es 生产集群的部署架构是什么？每个索引的数据量大概有多少？每个索引大概有多少个分片？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/es-production-cluster.md)

### 缓存

- [在项目中缓存是如何使用的？缓存如果使用不当会造成什么后果？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/why-cache.md)
- [Redis 和 Memcached 有什么区别？Redis 的线程模型是什么？为什么单线程的 Redis 比多线程的 Memcached 效率要高得多？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-single-thread-model.md)
- [Redis 都有哪些数据类型？分别在哪些场景下使用比较合适？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-data-types.md)
- [Redis 的过期策略都有哪些？手写一下 LRU 代码实现？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-expiration-policies-and-lru.md)
- [如何保证 Redis 高并发、高可用？Redis 的主从复制原理能介绍一下么？Redis 的哨兵原理能介绍一下么？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/how-to-ensure-high-concurrency-and-high-availability-of-redis.md)
- [Redis 的持久化有哪几种方式？不同的持久化机制都有什么优缺点？持久化机制具体底层是如何实现的？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-persistence.md)
- [Redis 集群模式的工作原理能说一下么？在集群模式下，Redis 的 key 是如何寻址的？分布式寻址都有哪些算法？了解一致性 hash 算法吗？如何动态增加和删除一个节点？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-cluster.md)
- [了解什么是 Redis 的雪崩和穿透？Redis 崩溃之后会怎么样？系统该如何应对这种情况？如何处理 Redis 的穿透？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-caching-avalanche-and-caching-penetration.md)
- [如何保证缓存与数据库的双写一致性？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-consistence.md)
- [Redis 的并发竞争问题是什么？如何解决这个问题？了解 Redis 事务的 CAS 方案吗？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-cas.md)
- [生产环境中的 Redis 是怎么部署的？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/redis-production-environment.md)

### 分库分表

- [为什么要分库分表（设计高并发系统的时候，数据库层面该如何设计）？用过哪些分库分表中间件？不同的分库分表中间件都有什么优点和缺点？你们具体是如何对数据库如何进行垂直拆分或水平拆分的？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/database-shard.md)
- [现在有一个未分库分表的系统，未来要分库分表，如何设计才可以让系统从未分库分表动态切换到分库分表上？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/database-shard-method.md)
- [如何设计可以动态扩容缩容的分库分表方案？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/database-shard-dynamic-expand.md)
- [分库分表之后，id 主键如何处理？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/database-shard-global-id-generate.md)

### 读写分离

- [如何实现 MySQL 的读写分离？MySQL 主从复制原理是啥？如何解决 MySQL 主从同步的延时问题？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/mysql-read-write-separation.md)

### 高并发系统

- [如何设计一个高并发系统？](https://github.com/ousp2008/advanced-java/blob/master/docs/high-concurrency/high-concurrency-design.md)

## 分布式系统

### [面试连环炮](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-system-interview.md)

### 系统拆分

- [为什么要进行系统拆分？如何进行系统拆分？拆分后不用 Dubbo 可以吗？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/why-dubbo.md)

### 分布式服务框架

- [说一下 Dubbo 的工作原理？注册中心挂了可以继续通信吗？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-operating-principle.md)
- [Dubbo 支持哪些序列化协议？说一下 Hessian 的数据结构？PB 知道吗？为什么 PB 的效率是最高的？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-serialization-protocol.md)
- [Dubbo 负载均衡策略和集群容错策略都有哪些？动态代理策略呢？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-load-balancing.md)
- [Dubbo 的 spi 思想是什么？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-spi.md)
- [如何基于 Dubbo 进行服务治理、服务降级、失败重试以及超时重试？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-service-management.md)
- [分布式服务接口的幂等性如何设计（比如不能重复扣款）？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-system-idempotency.md)
- [分布式服务接口请求的顺序性如何保证？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-system-request-sequence.md)
- [如何自己设计一个类似 Dubbo 的 RPC 框架？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/dubbo-rpc-design.md)

### 分布式锁

- [Zookeeper 都有哪些应用场景？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/zookeeper-application-scenarios.md)
- [使用 Redis 如何设计分布式锁？使用 Zookeeper 来设计分布式锁可以吗？以上两种分布式锁的实现方式哪种效率比较高？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-lock-redis-vs-zookeeper.md)

### 分布式事务

- [分布式事务了解吗？你们如何解决分布式事务问题的？TCC 如果出现网络连不通怎么办？XA 的一致性如何保证？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-transaction.md)

### 分布式会话

- [集群部署时的分布式 Session 如何实现？](https://github.com/ousp2008/advanced-java/blob/master/docs/distributed-system/distributed-session.md)

## 高可用架构

- [Hystrix 介绍](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-introduction.md)
- [电商网站详情页系统架构](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/e-commerce-website-detail-page-architecture.md)
- [Hystrix 线程池技术实现资源隔离](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-thread-pool-isolation.md)
- [Hystrix 信号量机制实现资源隔离](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-semphore-isolation.md)
- [Hystrix 隔离策略细粒度控制](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-execution-isolation.md)
- [深入 Hystrix 执行时内部原理](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-process.md)
- [基于 request cache 请求缓存技术优化批量商品数据查询接口](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-request-cache.md)
- [基于本地缓存的 fallback 降级机制](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-fallback.md)
- [深入 Hystrix 断路器执行原理](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-circuit-breaker.md)
- [深入 Hystrix 线程池隔离与接口限流](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-thread-pool-current-limiting.md)
- [基于 timeout 机制为服务接口调用超时提供安全保护](https://github.com/ousp2008/advanced-java/blob/master/docs/high-availability/hystrix-timeout.md)
...
- [微服务架构整个章节内容属额外新增，会陆续补充完善](https://github.com/ousp2008/advanced-java/blob/master)
- [关于微服务架构的描述](https://github.com/ousp2008/advanced-java/blob/master/docs/micro-services/microservices-introduction.md)
...
| ![one](https://github.githubassets.com/images/icons/emoji/unicode/0031-20e3.png) | ![two](https://github.githubassets.com/images/icons/emoji/unicode/0032-20e3.png) | ![three](https://github.githubassets.com/images/icons/emoji/unicode/0033-20e3.png) | ![four](https://github.githubassets.com/images/icons/emoji/unicode/0034-20e3.png) | ![five](https://github.githubassets.com/images/icons/emoji/unicode/0035-20e3.png) | ![six](https://github.githubassets.com/images/icons/emoji/unicode/0036-20e3.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| [JavaCore](https://github.com/ousp2008/javastack/blob/master/README.md#one-javacore) | [JavaTool](https://github.com/ousp2008/javastack/blob/master/README.md#two-javatool) | [JavaWeb](https://github.com/ousp2008/javastack/blob/master/README.md#three-javaweb) | [Database](https://github.com/ousp2008/javastack/blob/master/README.md#four-database) | [Algorithm](https://github.com/ousp2008/javastack/blob/master/README.md#five-algorithm) | [OS](https://github.com/ousp2008/javastack/blob/master/README.md#six-os) |

## ![one](https://github.githubassets.com/images/icons/emoji/unicode/0031-20e3.png) JavaCore

> [JavaCore](https://github.com/dunwu/JavaCore) 是对 Java 核心技术的总结。
>
> 内容包含：Java 基础特性、Java 高级特性、Java 并发、JVM、Java IO 等。

## ![two](https://github.githubassets.com/images/icons/emoji/unicode/0032-20e3.png) JavaTool

> [JavaTool](https://github.com/ousp2008/javastack/blob/master/docs) 是 Java 常用工具、lib 库的经验总结。
>
> 内容包含：Java 常用工具、lib 库等。

## ![three](https://github.githubassets.com/images/icons/emoji/unicode/0033-20e3.png) JavaWeb

> [JavaWeb](https://github.com/dunwu/JavaWeb) 是对 Java Web 领域开发经验的总结。
>
> 内容包含：JavaEE、单点式应用技术、分布式应用技术等。

## ![four](https://github.githubassets.com/images/icons/emoji/unicode/0034-20e3.png) Database

> [Database](https://github.com/dunwu/Database) 是对数据库领域开发经验的总结。
>
> 内容包含：数据库理论、Mysql、Redis 等。

## ![five](https://github.githubassets.com/images/icons/emoji/unicode/0035-20e3.png) Algorithm

> [Algorithm](https://github.com/dunwu/Algorithm) 是对数据结构和算法的总结。
>
> 内容包含：一些基本的数据结构、算法。

## ![six](https://github.githubassets.com/images/icons/emoji/unicode/0036-20e3.png) OS
...
- 开源组件实现
  - [MVC框架实现篇](https://github.com/ousp2008/java-bible#MVC%E6%A1%86%E6%9E%B6%E5%AE%9E%E7%8E%B0%E7%AF%87)
  - [IOC容器实现篇](https://github.com/ousp2008/java-bible#IOC%E5%AE%B9%E5%99%A8%E5%AE%9E%E7%8E%B0%E7%AF%87)
- [设计模式系列](https://github.com/ousp2008/java-bible#%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E7%B3%BB%E5%88%97)
- [Java8系列](https://github.com/ousp2008/java-bible#Java8%E7%B3%BB%E5%88%97)
- [Hexo搭建博客](https://github.com/ousp2008/java-bible#Hexo%E6%90%AD%E5%BB%BA%E5%8D%9A%E5%AE%A2)
- [开发者指南](https://github.com/ousp2008/java-bible#%E5%BC%80%E5%8F%91%E8%80%85%E6%8C%87%E5%8D%97)
- [运维相关](https://github.com/ousp2008/java-bible#%E8%BF%90%E7%BB%B4%E7%9B%B8%E5%85%B3)
- [经典文章](https://github.com/ousp2008/java-bible#%E7%BB%8F%E5%85%B8%E6%96%87%E7%AB%A0)

## 开源组件实现

### [MVC框架实现篇](https://github.com/ousp2008/java-bible/blob/master/mvc/index.md)

- [项目规划](https://github.com/ousp2008/java-bible/blob/master/mvc/1.plan.md)
- [路由设计](https://github.com/ousp2008/java-bible/blob/master/mvc/2.route.md)
- [控制器设计](https://github.com/ousp2008/java-bible/blob/master/mvc/3.controller.md)
- [配置设计](https://github.com/ousp2008/java-bible/blob/master/mvc/4.config.md)
- [视图设计](https://github.com/ousp2008/java-bible/blob/master/mvc/5.view.md)
- [数据库操作](https://github.com/ousp2008/java-bible/blob/master/mvc/6.dbutil.md)
- [增删改查](https://github.com/ousp2008/java-bible/blob/master/mvc/7.crud.md)

### [IOC容器实现篇](https://github.com/ousp2008/java-bible/blob/master/ioc/index.md)

- [IOC的概念](https://github.com/ousp2008/java-bible/blob/master/ioc/1.concept.md)
- [Spring中怎么用](https://github.com/ousp2008/java-bible/blob/master/ioc/2.spring.md)
- [设计一个IOC](https://github.com/ousp2008/java-bible/blob/master/ioc/3.myioc.md)
- [原理分析](https://github.com/ousp2008/java-bible/blob/master/ioc/4.principle.md)

## 设计模式系列

- [如何正确地写出单例模式](https://github.com/ousp2008/java-bible/blob/master/designpatterns/singleton.md)
- [代理模式剖析](https://github.com/ousp2008/java-bible/blob/master/designpatterns/proxy.md)
- [什么是策略模式](https://github.com/ousp2008/java-bible/blob/master/designpatterns/strategy.md)

## Java8系列

- [Java8简明教程](https://github.com/ousp2008/java-bible/blob/master/java8/java8-guide.md)
- [Java8 Foreach](https://github.com/ousp2008/java-bible/blob/master/java8/foreach.md)

## Hexo搭建博客

- [分分钟部署一个Hexo环境](https://github.com/ousp2008/java-bible/blob/master/hexo/hello.md)
- [各种配置详解](https://github.com/ousp2008/java-bible/blob/master/hexo/config.md)
- [开始写作吧](https://github.com/ousp2008/java-bible/blob/master/hexo/writing.md)

## 开发者指南

- [git - 简明指南](https://github.com/ousp2008/java-bible/blob/master/git/guide.md)
...
- [Google Java编程风格指南](https://github.com/ousp2008/java-bible/blob/master/user_guide/google-java8-guide.md)

## 运维相关

- [linux安装jdk、tomcat脚本](https://github.com/ousp2008/java-bible/blob/master/shell/install_jdk_tomcat.sh)
- [Web性能测试工具](https://github.com/ousp2008/java-bible/blob/master/web/test_tool.md)
- [Java 程序员眼中的 Linux](https://github.com/judasn/Linux-Tutorial)
- [写给java开发的运维笔记](https://github.com/ousp2008/java-bible/blob/master/learn_server/README.md)

## 经典文章

- [HTTP请求报文解剖](https://github.com/ousp2008/java-bible/blob/master/articles/request_message.md)
- [软件架构模式](https://github.com/ousp2008/java-bible/blob/master/articles/software_architecture_patterns.md)
- [电商网站架构案例](https://github.com/ousp2008/java-bible/blob/master/articles/electrical-business-architecture.md)

## 服务器/域名/SSL证书

- [可用域名](https://domainr.com/) | [秋玉米](http://www.qiuyumi.com/)
- [优惠域名](http://hk.hostsir.com/Affiliates/i/d/976) | [非主流域名](https://github.com/ousp2008/java-bible/blob/master)
...
- [1小时免费VPN](https://github.com/ousp2008/java-bible/blob/master)
...
## - Java基础
### - [面向对象](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/oop.md)
### -[基础](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/basic.md)
### -[集合](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/collections.md)
### -[多线程](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/multithread.md)
### -[JVM](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/jvm.md)
### -[IO](https://github.com/ousp2008/java_interview_manual/blob/master/java-basic/io.md)
- [设计模式](https://github.com/ousp2008/java_interview_manual/blob/master/design-pattern/index.md)
## - 数据结构与算法
### - [算法](https://github.com/ousp2008/java_interview_manual/blob/master/data-structures-and-algorithms/algorithms.md)
### -[数据结构](https://github.com/ousp2008/java_interview_manual/blob/master/data-structures-and-algorithms/data-structures.md)
## - JavaWeb
### -[JavaWeb基础](https://github.com/ousp2008/java_interview_manual/blob/master/java-web/java-web-basic.md)
### -[Spring系列](https://github.com/ousp2008/java_interview_manual/blob/master/java-web/spring.md)
### -[MyBatis](https://github.com/ousp2008/java_interview_manual/blob/master/java-web/mybatis.md)
### -Hibernate
## - 数据库与缓存
### -[数据库基本理论](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/db_basic.md)
### -[缓存基本理论](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/cache_basic.md)
### -[数据库索引](https://github.com/ousp2008/java_interview_manual/blob/master/db-cacahe/db-index.md)
### -[分库分表](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/sharding.md)
### -[MySQL](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/mysql.md)
### -[MongoDB](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/mongodb.md)
### -[Redis](https://github.com/ousp2008/java_interview_manual/blob/master/db-cache/redis.md)
## - 消息队列
### -[MQ基础](https://github.com/ousp2008/java_interview_manual/blob/master/mq/basic.md)
##  [分布式](https://github.com/ousp2008/java_interview_manual/blob/master/distributed/index.md)
##  [微服务](https://github.com/ousp2008/java_interview_manual/blob/master/mic-service/index.md)
## 安全和性能
### -[安全](https://github.com/ousp2008/java_interview_manual/blob/master/security-performance/security.md)
### -[性能](https://github.com/ousp2008/java_interview_manual/blob/master/security-performance/performance.md)
## 网络与服务器
### -[计算机网络](https://github.com/ousp2008/java_interview_manual/blob/master/network-server/network.md)
### -[Nginx](https://github.com/ousp2008/java_interview_manual/blob/master/network-server/nginx.md)
### - [Tomcat](https://github.com/ousp2008/java_interview_manual/blob/master/network-server/tomcat.md)
### -[Netty](https://github.com/ousp2008/java_interview_manual/blob/master/network-server/netty.md)
## 软件工程
### -[UML](https://github.com/ousp2008/java_interview_manual/blob/master/software_engineering-server/uml.md)
### -[业务](https://github.com/ousp2008/java_interview_manual/blob/master/business/index.md)
## [操作系统](https://github.com/ousp2008/java_interview_manual/blob/master/system/index.md)
...
- Java资源大全中文版
  - [古董级工具](https://github.com/ousp2008/awesome-java-cn#ancients)
  - [构建工具](https://github.com/ousp2008/awesome-java-cn#build)
  - [字节码操作](https://github.com/ousp2008/awesome-java-cn#bytecode-manipulation)
  - [集群管理](https://github.com/ousp2008/awesome-java-cn#cluster-management)
  - [代码分析](https://github.com/ousp2008/awesome-java-cn#code-analysis)
  - [编译器生成工具](https://github.com/ousp2008/awesome-java-cn#compiler-compiler)
  - [外部配置工具](https://github.com/ousp2008/awesome-java-cn#configuration)
  - [约束满足问题求解程序](https://github.com/ousp2008/awesome-java-cn#constraint-satisfaction-problem-solver)
  - [持续集成](https://github.com/ousp2008/awesome-java-cn#continuous-integration)
  - [CSV解析](https://github.com/ousp2008/awesome-java-cn#csv)
  - [数据结构](https://github.com/ousp2008/awesome-java-cn#data-structures)
  - [数据库](https://github.com/ousp2008/awesome-java-cn#database)
  - [时间日期工具库](https://github.com/ousp2008/awesome-java-cn#date-and-time)
  - [依赖注入](https://github.com/ousp2008/awesome-java-cn#dependency-injection)
  - [开发流程增强工具](https://github.com/ousp2008/awesome-java-cn#development)
  - [分布式应用](https://github.com/ousp2008/awesome-java-cn#distributed-applications)
  - [分布式数据库](https://github.com/ousp2008/awesome-java-cn#distributed-databases)
  - [发布](https://github.com/ousp2008/awesome-java-cn#distribution)
  - [文档处理工具](https://github.com/ousp2008/awesome-java-cn#document-processing)
  - [函数式编程](https://github.com/ousp2008/awesome-java-cn#functional-programming)
  - [游戏开发](https://github.com/ousp2008/awesome-java-cn#game-development)
  - [GUI](https://github.com/ousp2008/awesome-java-cn#gui)
  - [高性能计算](https://github.com/ousp2008/awesome-java-cn#high-performance)
  - [IDE](https://github.com/ousp2008/awesome-java-cn#ide)
  - [图像处理](https://github.com/ousp2008/awesome-java-cn#imagery)
  - [JSON](https://github.com/ousp2008/awesome-java-cn#json)
  - [JVM与JDK](https://github.com/ousp2008/awesome-java-cn#jvm-and-jdk)
  - [基于JVM的语言](https://github.com/ousp2008/awesome-java-cn#languages)
  - [日志](https://github.com/ousp2008/awesome-java-cn#logging)
  - [机器学习](https://github.com/ousp2008/awesome-java-cn#machine-learning)
  - [消息传递](https://github.com/ousp2008/awesome-java-cn#messaging)
  - [杂项](https://github.com/ousp2008/awesome-java-cn#miscellaneous)
  - [应用监控工具](https://github.com/ousp2008/awesome-java-cn#monitoring)
  - [原生开发库](https://github.com/ousp2008/awesome-java-cn#native)
  - [自然语言处理](https://github.com/ousp2008/awesome-java-cn#natural-language-processing)
  - [网络](https://github.com/ousp2008/awesome-java-cn#networking)
  - [ORM](https://github.com/ousp2008/awesome-java-cn#orm)
  - [PDF](https://github.com/ousp2008/awesome-java-cn#pdf)
  - [性能分析](https://github.com/ousp2008/awesome-java-cn#performance-analysis)
  - [响应式开发库](https://github.com/ousp2008/awesome-java-cn#reactive-libraries)
  - [REST框架](https://github.com/ousp2008/awesome-java-cn#rest-frameworks)
  - [科学计算与分析](https://github.com/ousp2008/awesome-java-cn#science)
  - [搜索引擎](https://github.com/ousp2008/awesome-java-cn#search)
  - [安全](https://github.com/ousp2008/awesome-java-cn#security)
  - [序列化](https://github.com/ousp2008/awesome-java-cn#serialization)
  - [应用服务器](https://github.com/ousp2008/awesome-java-cn#server)
  - [模板引擎](https://github.com/ousp2008/awesome-java-cn#template-engine)
  - [测试](https://github.com/ousp2008/awesome-java-cn#testing)
  - [通用工具库](https://github.com/ousp2008/awesome-java-cn#utility)
  - [网络爬虫](https://github.com/ousp2008/awesome-java-cn#web-crawling)
  - [Web框架](https://github.com/ousp2008/awesome-java-cn#web-frameworks)
  - [业务流程管理套件](https://github.com/ousp2008/awesome-java-cn#Business-Process-Management)
- 资源
  - [社区](https://github.com/ousp2008/awesome-java-cn#communities)
  - [有影响力的书](https://github.com/ousp2008/awesome-java-cn#influential-books)
  - [播客](https://github.com/ousp2008/awesome-java-cn#podcasts)
  - [微博、微信公众号](https://github.com/ousp2008/awesome-java-cn#weibo-weixin)
  - [Twitter](https://github.com/ousp2008/awesome-java-cn#twitter)
  - [知名网站](https://github.com/ousp2008/awesome-java-cn#websites)
...
- [JavaCC](https://github.com/ousp2008/awesome-java-cn/blob/master/JavaCC%EF%BC%9AJava%E8%AF%AD%E6%B3%95%E8%A7%A3%E6%9E%90%E5%99%A8%E7%94%9F%E6%88%90%E5%B7%A5%E5%85%B7)：JavaCC是更加专门的轻量级工具，易于上手且支持语法超前预测。[官网](https://javacc.java.net/)
...
- [fabric8](https://github.com/ousp2008/awesome-java-cn/blob/master/hao.jobbole.com/fabric8)：容器集成平台。[官网](http://fabric8.io/)
...
- ImportNew：是最受欢迎的、专注Java技术分享的微信公众号。专注Java技术分享，包括Java基础技术、进阶技能、架构设计和Java技术领域动态等。 
  [![img](https://camo.githubusercontent.com/7625acddd6081731eb5976dbcbbd432ae9a4db0b/687474703a2f2f7777322e73696e61696d672e636e2f736d616c6c2f3633393138363131677731657062326337727632756a3230343630343633796d2e6a7067)](https://camo.githubusercontent.com/7625acddd6081731eb5976dbcbbd432ae9a4db0b/687474703a2f2f7777322e73696e61696d672e636e2f736d616c6c2f3633393138363131677731657062326337727632756a3230343630343633796d2e6a7067)
